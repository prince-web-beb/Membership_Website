...
from waitress import serve  # Corrected import
...
os.makedirs(UPLOAD_FOLDER, exist_ok=True)  # Create uploads folder if not exist
...
if __name__ == "__main__":
    serve(app, host="0.0.0.0", port=8080)  # Corrected waitress serve
